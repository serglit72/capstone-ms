...
cat "eks-cluster-spot-copy.yaml" | sed "s/PRIVATE_SUB_01/$PRIVATE_SUB_01/g" |sed "s/PRIVATE_SUB_02/$PRIVATE_SUB_02/g"|sed "s/PUBLIC_SUB_01/$PUBLIC_SUB_01/g"|"s/PUBLIC_SUB_02/$PUBLIC_SUB_02/g"
