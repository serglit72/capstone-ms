...
template=cat "eks-cluster-spot-copy.yaml" | sed "s/PRIVATE_SUB_02/$PRIVATE_SUB_02/g"
template=cat "eks-cluster-spot-copy.yaml" | sed "s/PUBLIC_SUB_01/$PUBLIC_SUB_01/g"
template=cat "eks-cluster-spot-copy.yaml" | sed "s/PUBLIC_SUB_02/$PUBLIC_SUB_02/g"
